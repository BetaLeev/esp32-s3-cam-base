    ...
    <template #header>
      <div class="card-header">
        <div class="card-header-left">
          <el-icon :size="18" class="card-icon"><Connection /></el-icon>
          <span class="card-title">管脚列表</span>
        </div>
...
const hasActiveFilter = computed(() => searchKeyword.value || filterStatus.value || filterModule.value)
...
.gpio-used { color: $success-color; background: #f0f9eb; }
.gpio-free { color: $text-secondary; background: #f4f4f5; }
.gpio-reserved { color: $warning-color; background: #fdf6ec; }

.text-muted { color: $text-placeholder; }
.text-warning { color: $warning-color; font-weight: 500; }
